...
export const blogPosts: BlogPost[] = [
    {
        ...
        sections: [
            {
                title: 'Introduction',
                content: [
                    "Open, distributed ledgers and permissionless, censorship-resistant, trust-minimized computation are going to reshape massive sectors of the global economy. This belief led us to found FG Premium in 2017, and after spending two years with entrepreneurs, business leaders, and investors in this space, we've developed more conviction in this thesis than ever before.",
        ...
        disclaimer: {
            footer: "FG Premium 's investment thesis, the 'Crypto Mega Theses,' was first presented at the Spring 2019 FG Premium Summit.",
            disclosures: [
                "Disclosure: Unless otherwise indicated, the views expressed in this post are solely those of the author(s) in their individual capacity and are not the views of FG Premium Capital Management, LLC or its affiliates (together with its affiliates, 'FG Premium '). Certain information contained herein may have been obtained from third-party sources, including from portfolio companies of funds managed by FG Premium. FG Premium believes that the information provided is reliable but has not independently verified the non-material information and makes no representations about the enduring accuracy of the information or its appropriateness for a given situation.",
                ...
                "Past performance does not guarantee future results. There can be no guarantee that any FG Premium investment vehicle's investment objectives will be achieved, and the investment results may vary substantially from year to year or even from month to month. As a result, an investor could lose all or a substantial amount of its investment.",
                "FG Premium  has established, maintains and enforces written policies and procedures reasonably designed to identify and effectively manage conflicts of interest related to its investment activities. For more important disclosures, please see the Disclosures and Terms of Use available at https://forbespartners.org/main/disclosures and https://forbespartners.org/main/terms."
            ]
        }
    }
];
