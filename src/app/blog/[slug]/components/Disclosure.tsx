    ...
    return (
        <>
            ...
            <div className="sm:text-sm md:text-sm lg:text-sm">
                ...
                </p>                    <b className="titillium-web-semibold">Disclosure:</b> Unless otherwise indicated, the views expressed in this post are solely those of the author(s) in their individual capacity and are not the views of FG Premium Funds  Management, LLC or its affiliates (together with its affiliates, &quot;FG Premium Funds&quot;).
