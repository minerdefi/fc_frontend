    ...
    return (
        ...
        >
            ...
            <p className="mb-2 titillium-web-extralight-italic text-gray-600 dark:text-gray-400">
                Exits include (1) current and former Forbes Capital portfolio companies which may have been acquired and/or (2) where Forbes Capital sold tokens and/or equity. Certain portfolio companies on this list may still be held in Forbes Capital funds.
            </p>
            <p className="mb-2 titillium-web-extralight-italic text-gray-600 dark:text-gray-400">
