    ...
    const sections = [
        {
            ...
            content: [
                "1.1 FG Premium Management, LLC and its affiliates (herein referred to as \"FG Premium,\" \"we,\" \"us\" or \"our\") provide and make available this website (\"Site\") and its associated services, including email newsletters, associated content distribution platforms, and public FG Premium online social media accounts (the Site and the associated services collectively referred to as the \"Services\"). All use of the Services is subject to the terms and conditions contained in this Terms of Use Agreement (the \"Agreement\"). Please read this Agreement carefully. By accessing, browsing or otherwise using the Services, you acknowledge that you have read, understood, and agree to be bound by this Agreement. If you do not accept the terms and conditions of this Agreement, you shall not access, browse or use the Site or the Services.",
                "Except as otherwise noted on the Services, all content and material on the Services — including information, photos, podcasts, blog posts, videos, graphics/charts, icons, code, design, and overall appearance — are the property of FG Premium and should not be used, modified, or reproduced without our prior written consent. All trademarks, trade names, and logos displayed on the Services are the property of FG Premium, its affiliates, or their respective third-party owners, and the Services grants no license to them. FG Premium is a pending trademark in the United States and other countries and may not be used without the prior written permission of FG Premium."
            ]
        },
        {
            title: "2.0 Use of the Services.",
            content: [
                "2.1 FG Premium may provide content through the Services that is copyrighted or proprietary. You may not copy, reproduce, distribute, or create derivative works of such content without FG Premium's express permission.",
        ...
        },
        {
            ...
            content: [
                ...
                "3.2 In no event shall FG Premium or its affiliates be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in connection with the use or inability to use the Services, even if FG Premium has been advised of the possibility of such damages."
            ]
        },
        {
            title: "4.0 Indemnification.",
            content: [
                "4.1 You agree to indemnify, defend, and hold harmless FG Premium, its affiliates, and their respective officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, or expenses, including reasonable attorneys' fees and costs, arising out of or in any way connected with your access to or use of the Services."
            ]
        },
        {
            title: "5.0 Changes to the Agreement.",
            content: [
                "5.1 FG Premium reserves the right to modify this Agreement at any time. Any changes to this Agreement will be effective immediately upon posting. Your continued use of the Services after any such changes are posted constitutes your acceptance of the new Agreement."
            ]
        },
        {
