        ...
        >
            ...
            >
                ...
                <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <p>
                        Exits include current and former Forbes Capital portfolio companies which may have been acquired and/or where Forbes Capital sold tokens and/or equity. Certain portfolio companies on this list may still be held in Forbes Capital funds.
                    </p>
                    <p>
                        A list of investments made by funds managed by Forbes Capital is available here: <a href="https://forbespartners.org/main/portfolio/" target="_blank" rel="noopener noreferrer" className="text-[#308e87] hover:underline">https://forbespartners.org/main/portfolio/</a>
                    </p>
                    <p>
                    ...
                    <p>
                        Further, the list of investments is updated monthly and, as such, may not reflect the most recent Forbes Capital investments. Past results of Forbes Capital's investments, pooled investment vehicles, or investment strategies are not necessarily indicative of future results.
                    </p>
                    <p>
