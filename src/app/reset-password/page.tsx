                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#6B3FA0] hover:bg-[#277771] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6B3FA0] disabled:opacity-50"
                        >
